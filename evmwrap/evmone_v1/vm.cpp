...
evmc_set_option_result set_option(evmc_vm* c_vm, char const* c_name, char const* c_value) noexcept
{
    ...
    if (name == "O")
    {
        if (value == "0")
        {
            c_vm->execute = evmone_v1::baseline::execute;
            return EVMC_SET_OPTION_SUCCESS;
        }
        else if (value == "2")
        {
            c_vm->execute = evmone_v1::execute;
            return EVMC_SET_OPTION_SUCCESS;
        }
...
inline constexpr VM::VM() noexcept
  : evmc_vm{
        ...
        evmone_v1::destroy,
        evmone_v1::execute,
        evmone_v1::get_capabilities,
        evmone_v1::set_option,
    },
    m_first_tracer{}
{}
...
extern "C" {
EVMC_EXPORT evmc_vm* evmc_create_evmone_v1() noexcept
{
    return new evmone_v1::VM{};
}
}
